...
uint16_t menu_get_num_sections_callback2(MenuLayer *menu_layer, void *data){
	return 1;
}

uint16_t menu_get_num_rows_callback2(MenuLayer *menu_layer, uint16_t section_index, void *data){
...
int16_t menu_get_header_height_callback2(MenuLayer *menu_layer, uint16_t section_index, void *data){
    return MENU_CELL_BASIC_HEADER_HEIGHT;
}

void menu_draw_header_callback2(GContext* ctx, const Layer *cell_layer, uint16_t section_index, void *data) {
	switch(section_index){
		case 0:
...
void menu_draw_row_callback2(GContext* ctx, const Layer *cell_layer, MenuIndex *cell_index, void *data) {
