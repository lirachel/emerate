...
void momContact_load(Window *window){
	momName = text_layer_create(GRect(0, 10, 144, 168));
	...
	text_layer_set_text(momName, "Mom");
	layer_add_child(window_get_root_layer(momContact), text_layer_get_layer(momName));
	
	momNumber = text_layer_create(GRect(5, 50, 144, 168));
	...
	text_layer_set_text_alignment(momNumber, GTextAlignmentLeft);
	text_layer_set_text(momNumber, "Number: (123)456-7890");
...
void momContact_create(){
	...
	window_stack_push(momContact, true);
}
...
void dadContact_load(Window *window){
	dadName = text_layer_create(GRect(0, 10, 144, 168));
	...
	dadNumber = text_layer_create(GRect(5, 50, 144, 168));
	...
	text_layer_set_text_alignment(dadNumber, GTextAlignmentLeft);
	text_layer_set_text(dadNumber, "Number: (123)456-7890");
...
void dadContact_create(){
	...
	window_stack_push(dadContact, true);
}
